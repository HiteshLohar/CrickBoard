...
function Login() {
  ...
  return (
    <main className="min-h-screen overflow-hidden bg-slate-50 px-3 py-3 text-slate-900 transition-colors duration-200 dark:bg-slate-950 dark:text-white sm:px-4 sm:py-4">
      <div className="mx-auto flex min-h-[calc(100vh-1.5rem)] w-full max-w-4xl items-center justify-center sm:min-h-[calc(100vh-2rem)]">
        <div className="grid w-full overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-lg shadow-slate-200/40 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/20 lg:grid-cols-2">
          ...
          {/* Login Panel */}
          <section className="flex w-full items-center justify-center p-5 sm:p-6 lg:p-7">
