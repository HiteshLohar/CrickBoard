          ...
          <section className="flex w-full items-center justify-center p-5 sm:p-7 lg:p-8 xl:p-10">
            <div className="w-full max-w-sm">
              ...
              {success && (
                <div
                  role="status"
                  className="mb-4 flex items-start gap-2.5 rounded-xl border border-emerald-200 bg-emerald-50 px-3.5 py-2.5 text-xs font-semibold leading-5 text-emerald-700 dark:border-emerald-900/60 dark:bg-emerald-950/30 dark:text-emerald-300"
                >
                  <CheckCircle2
                    size={16}
