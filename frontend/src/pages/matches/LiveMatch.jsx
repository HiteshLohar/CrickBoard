    ...
    return (
        ...
        >
            <div className={compact ? 'flex items-center gap-2' : 'flex items-start gap-3'}>
                <div
                    className={[
                        'flex shrink-0 items-center justify-center rounded-xl bg-brand-50 text-brand-600 dark:bg-brand-950/60 dark:text-brand-400',
                ...
                <div>
                    <h2
                        className={
                            compact
                                ? 'text-sm font-black tracking-tight text-slate-900 dark:text-white'
                                : 'text-base font-black tracking-tight text-slate-900 dark:text-white sm:text-lg'
                        }
                    >
                        {title}
                    </h2>
                        ...
                        <p
                            className={
                                compact
                                    ...
                                    : 'mt-0.5 text-xs text-slate-500 dark:text-slate-400 sm:text-sm'
                            }
                        >
                            {description}
                        </p>
...
function PlayerCard({
    ...
    return (
        ...
        >
            ...
            <div className={compact ? 'relative flex items-center gap-2' : 'relative flex items-center gap-3'}>
                <div
                    className={[
                ...
                <div className="min-w-0 flex-1">
                    ...
                    <p className={compact ? 'truncate text-xs font-black text-slate-900 dark:text-white' : 'truncate text-sm font-black text-slate-900 dark:text-white'}>
                        {player?.name || '—'}
                    </p>
...
function StatCard({ icon: Icon, label, value, highlight = false, compact = false }) {
    return (
        <div
            className={[
                compact ? 'rounded-xl border p-1.5' : 'rounded-2xl border p-3 sm:p-4',
                highlight
        ...
        >
            <div className="flex items-center gap-2 text-slate-500 dark:text-slate-400">
                ...
                <span className={compact ? 'text-[8px] font-bold uppercase tracking-wider' : 'text-[10px] font-bold uppercase tracking-wider sm:text-xs'}>
                    {label}
                </span>
            </div>

            <p className={compact ? 'mt-0.5 text-[10px] font-black text-slate-900 dark:text-white' : 'mt-1 text-sm font-black text-slate-900 dark:text-white sm:text-base'}>
                {value}
            </p>
        </div>
    )
...
function LiveMatch() {
                ...
                <div className="mx-auto max-w-xl">
                    <div className="rounded-3xl border border-red-200 bg-white p-8 text-center shadow-sm dark:border-red-900/50 dark:bg-slate-900">
                        ...
                        <button
                            ...
                            className="mt-4 inline-flex items-center gap-1.5 rounded-lg bg-slate-900 px-2.5 py-1.5 text-xs font-black text-white transition hover:-translate-y-0.5 hover:bg-slate-700 dark:bg-white dark:text-slate-900 dark:hover:bg-slate-200"
                        >
                            <ArrowLeft size={16} />
                            Back to Matches
                        </button>
    ...
    return (
        <section className="h-full min-h-0 overflow-hidden px-3 py-3 sm:px-5 sm:py-4 lg:px-8">
            <div className="mx-auto flex h-full min-h-0 max-w-7xl flex-col gap-3">
                ...
                <header className="flex shrink-0 flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    <div className="min-w-0">
                        <div className="flex min-w-0 items-center gap-20">
                            {/* Live Match */}
                            <span className="inline-flex shrink-0 items-center gap-1.5 rounded-full bg-red-50 px-2.5 py-1 text-[10px] font-black uppercase tracking-widest text-red-600 dark:bg-red-950/40 dark:text-red-400">
                            ...
                            {/* Completed */}
                            {isCompleted && (
                                <span className="inline-flex shrink-0 rounded-full bg-slate-100 px-2.5 py-1 text-[10px] font-black uppercase tracking-widest text-slate-600 dark:bg-slate-800 dark:text-slate-300">
                                    Completed
                                </span>
                            )}

                            {/* Team Name */}
                            <h1 className="shrink-0 text-xl font-black tracking-tight text-slate-950 dark:text-white sm:text-2xl">
                                {match?.title || 'Live Match'}
                            </h1>

                            {/* Match Code */}
                            <p className="shrink-0 text-xs font-medium text-slate-500 dark:text-slate-400 sm:text-sm">
                                {match?.matchCode || '-'}
                            </p>
                        </div>
                    </div>
                ...
                {(error || successMessage) && (
                    <div
                        className={[
                            'flex shrink-0 items-start gap-3 rounded-2xl border px-4 py-2 text-sm font-semibold',
                            error
                ...
                <div className="grid min-h-0 flex-1 gap-3 overflow-hidden lg:grid-cols-2">
                    ...
                    <div className="flex min-h-0 flex-col gap-3 overflow-hidden">
                        {/* Score Hero */}
                        {innings && (
                            <div className="relative h-[225px] shrink-0 overflow-hidden rounded-[2rem] border border-slate-200 bg-white shadow-xl shadow-slate-200/50 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/20">
                                    ...
                                    <div className="flex h-full flex-col justify-between gap-1">
                                        ...
                                        <div className="grid grid-cols-[1fr_auto_1fr] items-start gap-2">
                                            ...
                                            <div className="flex min-w-0 items-center gap-2 sm:gap-3">
                                                ...
                                                <div className="min-w-0">
                                                    <h2 className="truncate text-sm font-black uppercase text-slate-950 dark:text-white sm:text-base">
                                                    ...
                                                    <p className="mt-0.5 text-[9px] font-black uppercase tracking-widest text-brand-600 dark:text-brand-400 sm:text-[10px]">
                                                        Batting
                                                    </p>
                                                </div>
                                            </div>
                                            ...
                                            <div className="flex shrink-0 items-center justify-center pt-1">
                                                <span className="inline-flex items-center gap-1.5 rounded-full border border-red-200 bg-red-50 px-2.5 py-1 text-[9px] font-black uppercase tracking-wider text-red-600 dark:border-red-900/50 dark:bg-red-950/30 dark:text-red-400 sm:px-3 sm:py-1.5 sm:text-[10px]">
                                                    <span className="h-1.5 w-1.5 animate-pulse rounded-full bg-red-500" />
                                                    LIVE
                                                </span>
                                            </div>
                                            ...
                                            <div className="flex min-w-0 items-center justify-end gap-2 text-right sm:gap-3">
                                                <div className="min-w-0">
                                                    ...
                                                    <p className="mt-0.5 text-[9px] font-black uppercase tracking-widest text-orange-600 dark:text-orange-400 sm:text-[10px]">
                                                        Bowling
                                                    </p>
                                                </div>
                                        ...
                                        <div className="text-center">
                                            <p className="text-4xl font-black tracking-tighter text-slate-950 dark:text-white sm:text-5xl">
                                                {innings.totalRuns || 0}
                                        ...
                                        <div className="grid grid-cols-4 gap-1.5">
                                            ...
                                            <StatCard
                                                icon={Zap}
                                                label="Target"
                                                value={innings.target ? innings.target : '—'}
                                                compact
                                            />
                                        </div>
                                    </div>
                        ...
                        {openingPlayersSet &&
                            !requiresOpeningPlayers &&
                            innings?.status === 'LIVE' && (
                                <div className="min-h-0 flex-1 overflow-hidden rounded-3xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900 sm:p-5">
                                    <SectionTitle
                                        icon={Users}
                                    ...
                                    <div className="grid h-[58px] grid-cols-3 gap-1.5">
                                        <PlayerCard
                                            label="Striker"
                    ...
                    {/* RIGHT COLUMN — LIVE SCORING */}
                    {openingPlayersSet &&
                        !requiresOpeningPlayers &&
                        innings?.status === 'LIVE' && (
                            <div className="min-h-0 overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-lg shadow-slate-200/20 dark:border-slate-800 dark:bg-slate-900 dark:shadow-black/10">
                                <div className="border-b border-slate-100 px-4 py-2 dark:border-slate-800 sm:px-5 sm:py-3">                                    <SectionTitle
                                    icon={CircleDot}
                                    title="Live Scoring"
                                ...
                                >
                                                ...
                                                (runs) => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={[
                                                                'relative flex h-12 items-center justify-center overflow-hidden rounded-2xl border text-xl font-black transition-all duration-200 sm:h-12 sm:text-2xl',
                                                                selected
                                    ...
                                    <div className="mt-4 grid gap-3 lg:grid-cols-2">
                                        ...
                                        <div className="rounded-2xl border border-slate-200 bg-slate-50/70 p-3 dark:border-slate-800 dark:bg-slate-950/40">
                                            ...
                                            <div className="relative">
                                                <select
                                                    ...
                                                    className="w-full appearance-none rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 pr-10 text-sm font-bold text-slate-900 outline-none transition focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-700 dark:bg-slate-950 dark:text-white"
                                                >
                                                    <option value="NONE">
                                                        No Extra
                                                    </option>
                                                    ...
                                                    <div className="mt-2.5">
                                                        <label className="block">
                                                            ...
                                                            <input
                                                                ...
                                                                disabled={submitting}
                                                                className="w-full rounded-xl border border-slate-200 bg-white px-3 py-2.5 text-sm font-bold text-slate-900 outline-none focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-white"
                                                            />
                                                        </label>
                                                    </div>
                                                )}
                                        ...
                                        {/* Wicket */}
                                        <div className="rounded-2xl border border-red-200 bg-red-50/50 p-3 dark:border-red-900/40 dark:bg-red-950/20">
                                            <div className="mb-2.5 flex items-center gap-2">
                                                <Ban
                                                    size={15}
                                            ...
                                            <div className="relative">
                                                <select
                                                    value={playerOut}
                                                    onChange={(event) =>
                                                        setPlayerOut(event.target.value)
                                                    }
                                                    disabled={
                                                        submitting ||
                                                        !currentStrikerId
                                                    }
                                                    className="w-full appearance-none rounded-xl border border-red-200 bg-white px-3.5 py-2.5 pr-10 text-sm font-bold text-slate-900 outline-none transition focus:border-red-500 focus:ring-4 focus:ring-red-500/10 disabled:cursor-not-allowed disabled:opacity-50 dark:border-red-900/50 dark:bg-slate-950 dark:text-white"
                                                >
                                                    <option value="">
                                                        No Wicket
                                                    </option>
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <label>
                                            ...
                                            <input
                                                ...
                                                className="w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-sm font-semibold text-slate-900 outline-none transition focus:border-brand-500 focus:ring-4 focus:ring-brand-500/10 dark:border-slate-700 dark:bg-slate-950 dark:text-white"
                                            />
                                        </label>
                                    </div>
                                    ...
                                    <div className="mt-4 grid grid-cols-2 gap-3">
                                        ...
                                        <button
                                            ...
                                            className={[
                                                'inline-flex w-full items-center justify-center gap-2 rounded-2xl px-5 py-3 text-sm font-black uppercase tracking-wide text-white transition-all duration-200',
                                                playerOut
